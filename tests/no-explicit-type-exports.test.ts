...
ruleTester.run('no-explicit-type-exports', rule, {
  valid: [
    {
      // The rule passes when a file imports and exports default variable
      filename: fileName,
      code: "import baz from './bar'; export {baz}",
    },
    {
      // The rule passes when a file imports and exports default variable
    ...
    {
      // The rule succeeds single line imported/exported types
      filename: fileName,
  ...
  invalid: [
    {
      ...
      errors: [
        {
          message: "Do not import 'bar' it is an exported type or interface.",
        },
        {
          message: "Do not export 'bar' it is an exported type or interface.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      errors: [
        {
          message: "Do not import 'foo' it is an exported type or interface.",
        },
        {
          message: "Do not export 'foo' it is an exported type or interface.",
        },
      ],
    },
    {
      ...
      errors: [
        {
          message: "Do not import 'baz' it is an exported type or interface.",
        },
        {
          message: "Do not export 'baz' it is an exported type or interface.",
        },
      ],
    },
    {
      ...
      errors: [
        {
          message:
            "Do not export 'baz as IBaz' it is an exported type or interface.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      errors: [
        {
          message: "Do not import 'aType' it is an exported type or interface.",
        },
        {
          message: "Do not export 'aType' it is an exported type or interface.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      errors: [
        {
          message: "Do not import 'bar' it is an imported type or interface.",
        },
        {
          message: "Do not export 'bar' it is an exported type or interface.",
        },
        {
          message: "Do not import 'foo' it is an imported type or interface.",
        },
        {
          message: "Do not export 'foo' it is an exported type or interface.",
        },
    ...
    },
    {
      ...
      errors: [
        {
          message: "Do not export 'x' it is an exported type or interface.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      errors: [
        {
          message: "Do not import 'x' it is an exported type or interface.",
        },
      ],
    },
  ],
